...
//! \note This is used to express TCP sequence numbers (seqno) and acknowledgment numbers (_ackno)
class WrappingInt32 {
  private:
...
//! \returns the absolute sequence number that wraps to `n` and is closest to `_checkpoint`
//!
